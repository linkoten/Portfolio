...
const Header: React.FC<HeaderProps> = ({ onSectionChange }) => {
    ...
    return (
        <header className='lg:w-[526px] h-[144px] hidden lg:block p-[30px] ml-auto mb-10 rounded-[16px] bg-slate-800 hover:brightness-125 hover:ring-2 hover:ring-emerald-500 dark:bg-[#111111] shadow-lg shadow-slate-900 '>
